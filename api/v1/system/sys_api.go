...
// @Router    /xhs_api/getApiList [post]
...
// @accept    application/json
// @Produce   application/json
// @Param     data  body      bodo_request.GetById                                   true  "根据id获取api"
// @Success   200   {object}  response.Response{data=systemRes.SysAPIResponse}  "根据id获取api,返回包括api详情"
// @Router    /xhs_api/getApiById [post]
func (s *SystemApiApi) GetApiById(c *gin.Context) {
	var idInfo bodo_request.GetById
...
// @Router    /xhs_api/getAllApis [post]
...
// @accept    application/json
// @Produce   application/json
// @Param     data  body      bodo_request.IdsReq                 true  "ID"
// @Success   200   {object}  response.Response{msg=string}  "删除选中Api"
// @Router    /xhs_api/deleteApisByIds [delete]
func (s *SystemApiApi) DeleteApisByIds(c *gin.Context) {
	var ids bodo_request.IdsReq
